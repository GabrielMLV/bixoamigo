...
public class PetController {
    ...
    public ResponseEntity<List<ResponsePetDTO>> all(){
        return ResponseEntity.ok().body(ResponsePetDTO.converterPets(this.petService.findAll()));
    }
    ...
    public ResponseEntity<ResponsePetDTO> buscarPet(@PathVariable Long id) throws PetException {
